...
var userReducer = function userReducer() {
  ...
  switch (action.type) {
    case 'CHANGE_NAME':
      {
        state = _extends({}, state, { name: action.payload.name });
        break;
      }
    case 'CHANGE_AGE':
      {
        state = _extends({}, state, { age: action.payload.age });
        break;
      }
    ...
    case 'RECEIVE_USERS':
      {
        return _extends({}, state, { fetching: false, fetched: true, fetched_users: action.payload });
        break;
      }
  }
