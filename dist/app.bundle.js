...
var Layout = (_dec = (0, _redux.connect)(function (store) {
  return {
    user: store.user
  };
...
var _reactLogger = __webpack_require__(71);

var _reactLogger2 = _interopRequireDefault(_reactLogger);
...
var console = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isPromise_js__ = __webpack_require__(76);
...
var _tweetsReducer = __webpack_require__(78);
...
function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { tweets: [], fetching: false, fetched: false, error: null };
  var action = arguments[1];
...
function reducer() {
  ...
  switch (action.type) {
    ...
    case 'FETCH_USER_FULFILLED':
      {
        return _extends({}, state, { fetching: false, fetched: false, user: action.payload });
        break;
      }
